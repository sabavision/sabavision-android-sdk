...
public class AdColonyInterstitial extends CustomEventInterstitial implements AdColonyAdListener {
    ...
    protected void loadInterstitial(Context context,
        ...
        if (!(context instanceof Activity)) {
            customEventInterstitialListener.onInterstitialFailed(SabaVisionErrorCode.ADAPTER_CONFIGURATION_ERROR);
            return;
        }
    ...
    protected void showInterstitial() {
        if (mAdColonyVideoAd.isReady()) {
            ...
            Log.d("SabaVision", "Tried to show a AdColony interstitial ad before it finished loading. Please try again.");
        }
    }
    ...
    private void scheduleOnInterstitialLoaded() {
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                if (mAdColonyVideoAd.isReady()) {
                    Log.d("SabaVision", "AdColony interstitial ad successfully loaded.");
                    mIsLoading = false;
                    mScheduledThreadPoolExecutor.shutdownNow();
    ...
    public void onAdColonyAdStarted(AdColonyAd adColonyAd) {
        Log.d("SabaVision", "AdColony interstitial ad shown.");
        mHandler.post(new Runnable() {
            @Override
            public void run() {
    ...
    public void onAdColonyAdAttemptFinished(AdColonyAd adColonyAd) {
        Log.d("SabaVision", "AdColony interstitial ad dismissed.");
        mHandler.post(new Runnable() {
            @Override
            public void run() {
