...
import com.sabavision.common.util.Views;
...
public class FacebookBanner extends CustomEventBanner implements AdListener {
    ...
    public void onAdLoaded(Ad ad) {
        Log.d("SabaVision", "Facebook banner ad loaded successfully. Showing ad...");
        mBannerListener.onBannerLoaded(mFacebookBanner);
    }

    @Override
    public void onError(final Ad ad, final AdError error) {
        Log.d("SabaVision", "Facebook banner ad failed to load.");
        if (error == AdError.NO_FILL) {
            ...
            mBannerListener.onBannerFailed(SabaVisionErrorCode.UNSPECIFIED);
        }
    }

    @Override
    public void onAdClicked(Ad ad) {
        Log.d("SabaVision", "Facebook banner ad clicked.");
