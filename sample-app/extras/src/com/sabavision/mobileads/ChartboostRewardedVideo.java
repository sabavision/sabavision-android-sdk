...
public class ChartboostRewardedVideo extends CustomEventRewardedVideo {
    ...
    private void setUpMediationSettingsForRequest(String sabavisionId) {
        final ChartboostMediationSettings globalSettings =
                SabaVisionRewardedVideoManager.getGlobalMediationSettings(ChartboostMediationSettings.class);
        final ChartboostMediationSettings instanceSettings =
                SabaVisionRewardedVideoManager.getInstanceMediationSettings(ChartboostMediationSettings.class, sabavisionId);
    ...
    public void showVideo() {
        if (hasVideoAvailable()) {
            ...
            SabaVisionLog.d("Attempted to show Chartboost rewarded video before it was available.");
        }
    }
