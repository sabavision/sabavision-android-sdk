    ...
    protected void loadInterstitial(final Context context, final CustomEventInterstitialListener customEventInterstitialListener,
        ...
        if (!initializeSDK(context)) {
            ...
            UI_THREAD_HANDLER.post(new Runnable() {
                @Override
                public void run() {
                    mInterstitialListener.onInterstitialFailed(SabaVisionErrorCode.INTERNAL_ERROR);
                }
            });
            return;
        }
    ...
    class MillennialInterstitialListener implements InterstitialListener {
        ...
        public void onExpired(InterstitialAd interstitialAd) {
            ...
            UI_THREAD_HANDLER.post(new Runnable() {
                @Override
                public void run() {
                    mInterstitialListener.onInterstitialFailed(SabaVisionErrorCode.NO_FILL);
                }
            });
        }
        ...
        public void onLoadFailed(InterstitialAd interstitialAd,
            ...
            final SabaVisionErrorCode sabavisionErrorCode;
            ...
            UI_THREAD_HANDLER.post(new Runnable() {
                @Override
                public void run() {
                    mInterstitialListener.onInterstitialFailed(sabavisionErrorCode);
                }
            });
        }
