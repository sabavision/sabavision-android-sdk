...
public class FacebookNative extends CustomEventNative {
    ...
    protected void loadNativeAd(final Context context,
        ...
        if (sIsVideoRendererAvailable == null) {
            try {
                Class.forName("com.sabavision.nativeads.FacebookAdRenderer");
     ...
     * the "video_enabled" key that may be sent from the SabaVision ad server.
     * com.sabavision.nativeads.FacebookAdRenderer must also be used to display video-enabled ads.
     *
     ...
     * <p/>
     * If you use a custom renderer class that is not com.sabavision.nativeads.FacebookAdRenderer to show
    ...
    static class FacebookVideoEnabledNativeAd extends BaseNativeAd implements AdListener, ImpressionListener {
         ...
         * with SabaVision's direct-sold native ads or from mediated networks that pass back additional
         * fields.
         */
        ...
        private void setStarRating(final Double starRating) {
            if (starRating == null) {
                ...
                SabaVisionLog.d("Ignoring attempt to set invalid star rating (" + starRating + "). Must be "
